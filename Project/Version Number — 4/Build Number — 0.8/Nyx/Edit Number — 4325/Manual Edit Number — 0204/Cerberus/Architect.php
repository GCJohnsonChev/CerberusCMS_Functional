...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Pages','023','?Application_Member&#61;Pages&amp;Display&#61;Options','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Recommendations','024','?Application_Member&#61;Recommendations','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Referrers','025','?Application_Member&#61;Referrers&amp;Display&#61;Box','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Register','026','?Application_Member&#61;Register','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('RSS Feed','027','./RSS.php?','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Search','028','?Application_Member&#61;Search','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Statistics','029','?Application_Member&#61;Statistics','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Submit Link','030','?Application_Member&#61;Links&amp;SubmitLink&#61;Yes','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Submit News','031','?Application_Member&#61;Submit_News','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Upload File','032','?Application_Member&#61;Upload','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('VoIP Phone','033','?Application_Member&#61;VoIP','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url,application_link_timestamp_installation)VALUES('Welcome !','034','?Application_Custom&#61;1','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_applications(application_file_integrity,application_file_integrity_installation,application_file_name,application_file_permission,application_file_permission_camera,application_file_permission_microphone,application_file_permission_location_gps,application_file_permission_location_glo,application_file_permission_location_internet_protocol_address,application_file_status,application_file_timestamp_installation)VALUES('','','Pages','0','1','1','1','1','1','1','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
...
'Unknown :: Race :: 3',
'Unknown :: Race :: 4',
'Hi ! I am the automated Services Account. This is the Master Account with Supreme Priviliges System-Wide. You cannot Login to this account. You cannot Authenticate into this Account. There is no Password or Electronic Mail Address On This Account. This is an Automated Services Account that automatically performs Services Root Administration-Level Actions and Programming Code set by the Administration with Root Administration-Level Access. You can however send commands to me so that I can perform or execute a task from either the Administration Control Panel Terminal or by sending an escalated command through the Automated Root Administration-Level Robot Account.',
...
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_024	= "Links";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_025	= "List";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_026	= "Login";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_027	= "Media_Player";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_028	= "Member_Directory";
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_029	= "Messenger";
...
$_ARCHITECT_PERMISSIONS_FILES_FIND_DIRECTORY_APPLICATION_MEMBER_FILE_039	= "Statistics";
